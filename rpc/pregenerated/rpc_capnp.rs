...
pub mod message {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 233] = [
...
pub mod bootstrap {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 51] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(159, 3, 0, 0, 245, 3, 0, 0),
...
pub mod call {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[6,2,3,4,0,5,1];
...
pub mod return_ {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 149] = [
            ::capnp::word(0, 0, 0, 0, 6, 0, 6, 0),
            ::capnp::word(58, 87, 179, 61, 141, 178, 25, 158),
        ...
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[7,0,4,3,1,2,5,6];
...
pub mod payload {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_cap_table(&mut self, value: ::capnp::struct_list::Reader<'_,crate::rpc_capnp::cap_descriptor::Owned>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
        }
        #[inline]
...
pub mod promised_answer {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_transform(&mut self, value: ::capnp::struct_list::Reader<'_,crate::rpc_capnp::promised_answer::op::Owned>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false)
        }
        #[inline]
    ...
    pub mod op {
        ...
        mod _private {
            pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
                ...
                ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
                ::capnp::word(116, 9, 0, 0, 204, 9, 0, 0),
...
pub mod third_party_cap_descriptor {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
            ...
            ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(208, 9, 0, 0, 30, 10, 0, 0),
...
pub mod exception {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 85] = [
            ...
            ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(32, 10, 0, 0, 251, 10, 0, 0),
            ::capnp::word(21, 0, 0, 0, 162, 0, 0, 0),
    ...
    impl ::capnp::introspect::Introspect for Type {
        fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&type_::ARENA, type_::get_annotation_types)).into() }
    }
    impl ::core::convert::From<Type> for ::capnp::dynamic_value::Reader<'_> {
        fn from(e: Type) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&type_::ARENA, type_::get_annotation_types).into()).into() }
    }
    ...
    pub(crate) static ENCODED_NODE: [::capnp::Word; 38] = [
        ...
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
        ::capnp::word(157, 10, 0, 0, 249, 10, 0, 0),
        ::capnp::word(21, 0, 0, 0, 202, 0, 0, 0),
        ::capnp::word(33, 0, 0, 0, 7, 0, 0, 0),
        ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod provide {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 65] = [
            ...
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(253, 10, 0, 0, 100, 11, 0, 0),
            ::capnp::word(21, 0, 0, 0, 146, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(25, 0, 0, 0, 175, 0, 0, 0),
...
pub mod accept {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 65] = [
            ...
            ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(102, 11, 0, 0, 196, 11, 0, 0),
            ::capnp::word(21, 0, 0, 0, 138, 0, 0, 0),
            ::capnp::word(29, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(25, 0, 0, 0, 175, 0, 0, 0),
...
pub mod join {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_target(self) -> ::capnp::any_pointer::Reader<'a> {
            ::capnp::any_pointer::Reader::new(self.reader.get_pointer_field(0))
        }
        #[inline]
        pub fn has_target(&self) -> bool {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn get_target(self) -> ::capnp::any_pointer::Builder<'a> {
            ::capnp::any_pointer::Builder::new(self.builder.get_pointer_field(0))
        }
        #[inline]
        pub fn init_target(self, ) -> ::capnp::any_pointer::Builder<'a> {
            let mut result = ::capnp::any_pointer::Builder::new(self.builder.get_pointer_field(0));
            result.clear();
            result
        }
    ...
    impl Pipeline  {
        pub fn get_target(&self) -> ::capnp::any_pointer::Pipeline {
            ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(0))
        }
    }
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 48] = [
            ...
            ::capnp::word(1, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(198, 11, 0, 0, 11, 12, 0, 0),
            ::capnp::word(21, 0, 0, 0, 122, 0, 0, 0),
            ::capnp::word(25, 0, 0, 0, 7, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
...
pub mod disembargo {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_context(self) -> ::capnp::any_pointer::Reader<'a> {
            ::capnp::any_pointer::Reader::new(self.reader.get_pointer_field(1))
        }
        #[inline]
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn get_context(self) -> ::capnp::any_pointer::Builder<'a> {
            ::capnp::any_pointer::Builder::new(self.builder.get_pointer_field(1))
        }
        #[inline]
        pub fn init_context(self, ) -> ::capnp::any_pointer::Builder<'a> {
            let mut result = ::capnp::any_pointer::Builder::new(self.builder.get_pointer_field(1));
            result.clear();
            result
        }
    ...
    impl Pipeline  {
        ...
        pub fn get_context(&self) -> ::capnp::any_pointer::Pipeline {
            ::capnp::capability::FromTypelessPipeline::new(self._typeless.get_pointer_field(1))
        }
    }
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 48] = [
            ...
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(13, 12, 0, 0, 88, 12, 0, 0),
