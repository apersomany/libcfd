...
pub mod connect_request {
    ...
    mod _private {
        ...
        pub(crate) const TYPE_ID: u64 = 0xc471_16a1_045e_4061;
    }
}
...
impl ::capnp::introspect::Introspect for ConnectionType {
    fn introspect() -> ::capnp::introspect::Type { ::capnp::introspect::TypeVariant::Enum(::capnp::introspect::RawEnumSchema::new(&connection_type::ARENA, connection_type::get_annotation_types)).into() }
}
impl ::core::convert::From<ConnectionType> for ::capnp::dynamic_value::Reader<'_> {
    fn from(e: ConnectionType) -> Self { ::capnp::dynamic_value::Enum::new(e.into(), ::capnp::introspect::RawEnumSchema::new(&connection_type::ARENA, connection_type::get_annotation_types).into()).into() }
}
...
pub mod metadata {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 50] = [
            ...
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(114, 1, 0, 0, 189, 1, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0xe144_6b97_bfd1_cd37;
    }
}
...
pub mod connect_response {
    ...
    mod _private {
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[0,1];
        pub(crate) const TYPE_ID: u64 = 0xb103_2ec9_1cef_8727;
    }
}
